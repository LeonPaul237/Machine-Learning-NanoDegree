...
class InteractiveShell(SingletonConfigurable):
    ...
    **Deprecated**
    ...
    def _prompt_trait_changed(self, change):
        name = change['name']
        warn(
            "InteractiveShell.{name} is deprecated since IPython 4.0 and ignored since 5.0, set TerminalInteractiveShell.prompts object directly.".format(
                name=name)
        )
    ...
    def main_mod(selfself, filename, modname):
        os_path = os.path.abspath(filename)
    ...
    def enable_matplotlib(self, gui=None):
        ...
        steps ceded for interactive console
