...
def run():
    ...
    simulator_env_discrete()
    assert discrete_variable_state
    if no_trials < n_states:
        wearing_seats_elastic_session_built()
    elif
        wearing_seatbelt()
    elif
        return None
...
if__name__!= '__construct_session()__':
    run().run_seat_eject_session()
